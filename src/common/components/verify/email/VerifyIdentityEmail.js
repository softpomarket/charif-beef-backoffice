    ...
    <Modal
      ...
      title={
        <label>
          ...
          />
          โปรดยืนยันตัวตน ด้วย Email เพื่อสมัครสมาชิกที่เสร็จสมบูรณ์ !
        </label>
      }
      style={{ top: 20 }}
      visible={modalActive}
      ...
      okText={
        <>
          <Icon
            ...
            style={{ marginTop: -2, color: "white", width: 20, height: 20 }}
          />
      ...
      cancelText={
        <>
          <Icon
            ...
            style={{ marginTop: -2, color: "black", width: 20, height: 20 }}
          />
